              ...
              <div>
                ...
                {ob.location !== "gym" && (
                  <div style={{ marginBottom: 12 }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                      {[{ id: "dumbbell", label: "Dumbbells" }, { id: "barbell", label: "Barbell" }, { id: "resistance_band", label: "Resistance Bands" }, { id: "pullup_bar", label: "Pull-Up Bar" }, { id: "bench", label: "Bench" }, { id: "kettlebell", label: "Kettlebell" }, { id: "dip_bar", label: "Dip Bars" }].map(e => {
                        const has = ob.equipment.includes(e.id);
                        return (
                          <button key={e.id} onClick={() => setOb(o => ({ ...o, equipment: o.equipment.includes(e.id) ? o.equipment.filter(x => x !== e.id) : [...o.equipment, e.id] }))} style={{ padding: "10px 14px", background: has ? "rgba(255,107,107,0.08)" : "rgba(255,255,255,0.03)", border: `1px solid ${has ? "rgba(255,107,107,0.3)" : "rgba(255,255,255,0.07)"}`, borderRadius: 10, color: has ? "#FF6B6B" : "rgba(255,255,255,0.5)", fontSize: 12, cursor: "pointer", textAlign: "left", display: "flex", justifyContent: "space-between" }}>
                      ...
                      <div>
                        <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
                          <div style={{ flex: 1 }}>
                            ...
                            <input type="date" value={editMetricDate} onChange={e => setEditMetricDate(e.target.value)} style={{ width: "100%", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8, color: "#fff", fontSize: 12, padding: "8px 10px", outline: "none", boxSizing: "border-box", fontFamily: "'Space Mono', monospace", colorScheme: "dark" }} />
                          </div>
                        </div>
                        <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
                          <div style={{ flex: 1 }}>
                            ...
                            <input type="number" value={editMetricWeight} onChange={e => setEditMetricWeight(e.target.value)} placeholder="e.g. 80.5" style={{ width: "100%", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8, color: "#fff", fontSize: 13, padding: "8px 10px", outline: "none", boxSizing: "border-box", fontFamily: "'Space Mono', monospace" }} />
                          </div>
                          <div style={{ flex: 1 }}>
                            ...
                            <input type="number" value={editMetricBf} onChange={e => setEditMetricBf(e.target.value)} placeholder="e.g. 18.5" style={{ width: "100%", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: 8, color: "#fff", fontSize: 13, padding: "8px 10px", outline: "none", boxSizing: "border-box", fontFamily: "'Space Mono', monospace" }} />
                          </div>
                        </div>
                        <div style={{ display: "flex", gap: 8 }}>
                          ...
                          <button onClick={() => setEditingMetricId(null)} style={{ padding: "8px 12px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 8, color: "rgba(255,255,255,0.4)", fontSize: 10, cursor: "pointer" }}>Cancel</button>
                        </div>
                      </div>
                    ) : (
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                        ...
                        <div style={{ display: "flex", gap: 4, alignItems: "center" }}>
                          <button onClick={() => { setEditingMetricId(m.id); setEditMetricWeight(m.weightKg != null ? String(m.weightKg) : ""); setEditMetricBf(m.bodyFatPct != null ? String(m.bodyFatPct) : ""); setEditMetricDate(new Date(m.date).toISOString().split("T")[0]); }} style={{ background: "none", border: "none", color: "rgba(255,255,255,0.3)", fontSize: 14, cursor: "pointer", padding: "4px 6px" }}>✎</button>
