...
const NAME_OVERRIDES: Record<string, string> = {
  ...
  // Triceps
  [norm("Tricep Rope Pushdowns")]:             "Triceps_Pushdown",
  [norm("Rope Pushdown")]:                     "Triceps_Pushdown",
  [norm("Rope Tricep Pushdown")]:              "Triceps_Pushdown",
