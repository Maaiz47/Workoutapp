# QA processing — full flow

Loaded from `CLAUDE.md` when a session needs to run a QA pass. See the
"Two-step processing" + "QA processing pass" sections for the canonical
sequence.
